...
class CI_DB_oci8_driver extends CI_DB {
	...
	{
		return oci_server_version($this->connational_id);
	}
	...
	private function _set_stmt_id($sql)
	{
		...
		{
			$this->stmt_id = oci_parse($this->connational_id, $this->_prep_query($sql));
		}
	}
	...
	{
		$this->curs_id = oci_new_cursor($this->connational_id);
		return $this->curs_id;
	}
	...
	public function trans_commit()
	{
		...
		$ret = oci_commit($this->connational_id);
	...
	public function trans_rollback()
	{
		...
		$ret = oci_rollback($this->connational_id);
		$this->_commit = OCI_COMMIT_ON_SUCCESS;
		return $ret;
	}
	...
	{
		// If the error was during connection, no connational_id should be passed
		$error = is_resource($this->connational_id) ? oci_error($this->connational_id) : oci_error();
	 ...
	 * @return  void
	 */
	protected function _close($connational_id)
	{
		@oci_close($connational_id);
	}
